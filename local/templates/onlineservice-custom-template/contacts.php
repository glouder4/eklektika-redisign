                        ...
                        <div class="how_to_find_us">
                            ...
                            <div class="how_to_find_us--description">
                                <div class="how_to_find_us--description-item">
                                    ...
                                    <p>
                                        Офис находится в Бизнесс-центре "Юнион", вход через центральные двери со стороны Рязанского проспекта (под вывеской ПЕНЕТРОН). На проходной обратиться в бюро пропусков и выписать пропуск в компанию «ЙОкаталог» (обязательно наличие паспорта). Подняться на 12 этаж, после стеклянных дверей повернуть налево.
                                    </p>
                                </div>
                                <div class="how_to_find_us--description-item">
                                    <p style="font-weight: bold;">
                                    ...
                                    <p>
                                        На проходной обратиться в бюро пропусков и выписать пропуск в компанию «ЙОкаталог» (обязательно наличие паспорта или водительского удостоверения). На территории пройти к зданию, стоящему напротив, подняться по пандусу, внутри здания пройти вдоль грузовых лифтов налево
                                        к пассажирскому лифту и подняться на 7-ой этаж. В здании ориентируйтесь по указателям с надписью «ЙОкаталог».
                                    </p>
                                </div>
                            </div>
                        </div>
