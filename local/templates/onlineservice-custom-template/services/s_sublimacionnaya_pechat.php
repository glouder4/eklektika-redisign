...
$GLOBALS["OS_BREADCRUMBS"] = [
    [
        'ITEM' => "Сублимационная печать",
        "LINK" => "/services/s_sublimacionnaya_pechat/",
    ]
];
?>
<div class="container">
            ...
            <div class="alert-card">
                <div class="alert-card--description">
                    <?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
                            "AREA_FILE_SHOW" => "file",
                            "PATH" => "/local/templates/onlineservice-custom-template/services/include/index_s_sublimacionnaya_pechat.php",
                            "AREA_FILE_SUFFIX" => "",
                            "EDIT_TEMPLATE" => ""
                        )
                    );?>
