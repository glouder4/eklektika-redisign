                ...
                <div class="service-description-list--item">
                    ...
                    <div class="service-description-list--item--data">
                        <div class="service-description-list--item_title">
                            <span>Высокое качество изображения</span>
                        </div>
                        <div class="service-description-list--item_description">
                            <p>Печать на временный носитель осуществляется специальным принтером с высоким разрешением до 2880 dpi и в полноцветном режиме. Наилучшая цветопередача происходит при использовании светлых однотонных поверхностей.</p>
                        </div>
                    </div>
                </div>
                <div class="service-description-list--item">
