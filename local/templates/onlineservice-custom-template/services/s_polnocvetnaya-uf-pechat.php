...
$GLOBALS["OS_BREADCRUMBS"] = [
    [
        'ITEM' => "УФ-печать",
        "LINK" => "/services/s_polnocvetnaya-uf-pechat/",
    ]
];
?>
<div class="container">
            ...
            <div class="alert-card">
                <div class="alert-card--description">
                    <?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
                            "AREA_FILE_SHOW" => "file",
                            "PATH" => "/local/templates/onlineservice-custom-template/services/include/index_s_polnocvetnaya-uf-pechat.php",
                            "AREA_FILE_SUFFIX" => "",
                            "EDIT_TEMPLATE" => ""
                        )
                    );?>
        ...
        <div class="container">
            ...
            <div class="service-description-list_items">
                ...
                <div class="service-description-list--item">
                    ...
                    <div class="service-description-list--item--data">
                        <div class="service-description-list--item_title">
                            <span>Минимальная толщина негативных элементов (выворотки) 0,15 мм.</span>
                        </div>
                    </div>
                </div>
                <div class="service-description-list--item">
                    ...
                    <div class="service-description-list--item--data">
                        <div class="service-description-list--item_title">
                            <span>Для покрытия софт-тач минимальная толщина элементов 0,5 мм.</span>
                        </div>
                    </div>
                </div>
                <div class="service-description-list--item">
                    ...
                    <div class="service-description-list--item--data">
                        <div class="service-description-list--item_title">
                            <span>Разрешение растрового изображения от 300 dpi</span>
                        </div>
                    </div>
                </div>
                <div class="service-description-list--item">
                    ...
                    <div class="service-description-list--item--data">
                        <div class="service-description-list--item_title">
                            <span>Для макетов, содержащих мелкие элементы, разрешение от 600 до 1200 dpi</span>
                        </div>
                    </div>
                </div>
            </div>
