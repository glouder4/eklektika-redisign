...
<main class="main-content">
    ...
    <style>
        .discounts--item:nth-child(1){
            background-color: #744A9E;
        }
        .discounts--item:nth-child(2){
            background-color: #FBB040;
        }
        .discounts--item:nth-child(3){
            background-color: #57B0EA;
        }
        .discounts--item:nth-child(4){
	...
	array(
		...
		"COMPONENT_TEMPLATE" => "onlineservice-discounts"
	),
	false
);?>
    </div>
    <div class="container">
        <?$APPLICATION->IncludeComponent(
            ...
            Array(
                ...
                "PARENT_SECTION_CODE" => "",
                "PREVIEW_TRUNCATE_LEN" => "",
                "PROPERTY_CODE" => array("PERIOD_AKCII"),
                "SET_BROWSER_TITLE" => "N",
                "SET_LAST_MODIFIED" => "N",
                "SET_META_DESCRIPTION" => "N",
                "SET_META_KEYWORDS" => "N",
