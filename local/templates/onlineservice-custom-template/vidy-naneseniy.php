...
<main class="main-content">
    ...
    <div class="company--banner">
        <div class="backround-element">
            <a href="#" class="additional-background-element">
                <div class="borders">
                    <div class="border-top"></div>
                    <div class="border-left"></div>
                    <div class="border-bottom"></div>
                </div>
                <p><span style="color: #222222;">Смотрите видео<br>с нашего<br/>производства</p>

                <div class="action-element">
                    <svg xmlns="http://www.w3.org/2000/svg" width="85" height="85" viewBox="0 0 85 85" fill="none">
                        <circle cx="42.5" cy="42.5" r="42.5" fill="white"/>
                        <path d="M38.8 51L49 42.5L38.8 34" fill="#222222"/>
                        <path d="M38.8 51L49 42.5L38.8 34V51Z" stroke="#222222" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </div>
            </a>
            <img class="bg-image" src="/local/templates/onlineservice-custom-template/components/vidy-naneseniy/assets/bg-el.png" alt="">
        </div>
        <div class="company--banner_data container">
            <div class="company--banner_data--items">
                <div class="banner-title">
                    <span class="title">Мы печатаем на своем оборудовании!</span>
                </div>
    ...
    <div class="container">
        <div class="company-description--section">
            <div class="company-description--title">
                <h2 class="title">Виды нанесения логотипа и других изображений,<br/>которые мы применяем</h2>
            </div>
            <div class="company-description--text">
                <p class="text">
                    Компания ЙО!каталог выполняет нанесение логотипов на промопродукцию и бизнес сувениры из собственного ассортимента
                </p>
                <p class="text">
    ...
    <section class="services--blocks-list">
        <div class="services--blocks-list--items">
            <div class="services--blocks-list--item" data-color="1">
                ...
                <div class="services--blocks-list--item--body">
                    <div class="container">
                        <div class="services--blocks-list--item--body--columns">
                            <div class="services--blocks-list--item--body--column">
                                <div class="services--blocks-list--item--body--column_item--title">
            ...
            <div class="services--blocks-list--item" data-color="2">
                <div class="services--blocks-list--item--header">
                    <div class="container">
                        <div class="services--blocks-list--item--header--elements">
                            <div class="services--blocks-list--item--header--elements--counter">
                    ...
                    <div class="container">
                        <div class="services--blocks-list--item--body--columns">
                            <div class="services--blocks-list--item--body--column">
                                ...
                                <div class="services--blocks-list--item--body--column_item--description">
                                    <p>Тампонная печать позволяет наносить изображение и&nbsp;текст яркими и&nbsp;насыщенными цветами из&nbsp;палитры Pantone на&nbsp;плоские, криволинейные, а&nbsp;также мелкофактурные поверхности</p>
                                </div>
                            </div>
                            <div class="services--blocks-list--item--body--column">
                                <div class="services--blocks-list--item--body--column_item--title">
                                ...
                                <div class="services--blocks-list--item--body--column_item--description">
                                    <p>Для&nbsp;работы подходят практически любые пластик, керамика, стекло, металл, дерево, кожа. При&nbsp;высокой скорости изготовления промопродукции исходное изображение и&nbsp;текст переносятся максимально точно с&nbsp;детализацией линий до&nbsp;0,18&nbsp;мм. Это&nbsp;делает тампопечать самым распространённым способом брендирования крупных партий мелкой сувенирной продукции</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="services--blocks-list--item" data-color="3">
                <div class="services--blocks-list--item--header">
                    <div class="container">
                        <div class="services--blocks-list--item--header--elements">
                            <div class="services--blocks-list--item--header--elements--counter">
                    ...
                    <div class="container">
                        <div class="services--blocks-list--item--body--columns">
                            <div class="services--blocks-list--item--body--column">
                                ...
                                <div class="services--blocks-list--item--body--column_item--description">
                                    <p>УФ-печать применяется для&nbsp;изготовления рекламной полиграфической и&nbsp;иной продукции, персонализации сувениров и&nbsp;брендирования корпоративных подарков. Полноцветное, насыщенное, яркое, с&nbsp;возможностью 3D-эффекта изображение можно наносить практически на&nbsp;любые материалы</p>
                                </div>
                            </div>
                            <div class="services--blocks-list--item--body--column">
                                <div class="services--blocks-list--item--body--column_item--title">
                    ...
                    <div class="container">
                        <div class="services--blocks-list--item--body--columns">
                            <div class="services--blocks-list--item--body--column">
                                ...
                                <div class="services--blocks-list--item--body--column_item--description">
                                    <p>Шелкография (трафаретная печать) — распространённый метод нанесения изображений, рисунков и&nbsp;логотипов. Главное преимущество шелкографии&nbsp;— низкая себестоимость</p>
                                </div>
                            </div>
                            <div class="services--blocks-list--item--body--column">
                                <div class="services--blocks-list--item--body--column_item--title">
                                ...
                                <div class="services--blocks-list--item--body--column_item--description">
                                    <p>Позволяет быстро недорого выполнить печать изображения на&nbsp;различной рекламной и&nbsp;сувенирной продукции. Конечно, не&nbsp;стоит забывать что&nbsp;логотип, нанесённый таким методом, будет целостным и&nbsp;на&nbsp;долгое время сохранит свои цвета и&nbsp;яркость красок.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="services--blocks-list--item--body--columns">
                            <div class="services--blocks-list--item--body--column">
                                ...
                                <div class="services--blocks-list--item--body--column_item--description">
                                    <p>Метод тиснения позволяет наносить долговечные рельефные изображения на мягкие и пластичные материалы: кожу и кожзаменитель, бумагу и картон, дерево. В настоящее время наиболее распространена технология горячего тиснения, когда изображение выдавливается на мягкой обложке, упаковочном материале и т.п. заранее изготовленным металлическим штампом-клише, разогретым в термопрессе</p>
                                </div>
                            </div>
                            <div class="services--blocks-list--item--body--column">
                                <div class="services--blocks-list--item--body--column_item--title">
                                ...
                                <div class="services--blocks-list--item--body--column_item--description">
                                    <p>Он активно применяется для брендирования записных книжек, блокнотов, ежедневников, фирменных бланков, пригласительных билетов, визиток и визитниц, кожаных чехлов, портмоне других статусных изделий.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="services--blocks-list--item" data-color="6">
                <div class="services--blocks-list--item--header">
                    <div class="container">
                        <div class="services--blocks-list--item--header--elements">
                            <div class="services--blocks-list--item--header--elements--counter">
                    ...
                    <div class="container">
                        <div class="services--blocks-list--item--body--columns">
                            <div class="services--blocks-list--item--body--column">
                                ...
                                <div class="services--blocks-list--item--body--column_item--description">
                                    <p>Метод нанесения, главным образом, однотонного рельефного изображения на подарки, сувениры, промопродукцию и предметы повседневного обихода, включая бытовую технику и посуду</p>
                                </div>
                            </div>
                            <div class="services--blocks-list--item--body--column">
                                <div class="services--blocks-list--item--body--column_item--title">
                                ...
                                <div class="services--blocks-list--item--body--column_item--description">
                                    <p>Подходит для работы практически с любыми материалами: металлы, в том числе драгоценные (платина, золото, серебро), стекло, хрусталь, дерево, кожа, камень, вспененная резина, пластик. Возможно нанесение как простых, так и сложных, с высокой степенью детализации объектов, включая фотографии, на плоские и округлые поверхности.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="services--blocks-list--item--body--columns">
                            <div class="services--blocks-list--item--body--column">
                                ...
                                <div class="services--blocks-list--item--body--column_item--description">
                                    <p>Сублимационная печать относится к числу непрямых методов нанесения изображения, когда для переноса рисунка используется временный бумажный или пленочный носитель. </p>
                                </div>
                            </div>
                            <div class="services--blocks-list--item--body--column">
                                <div class="services--blocks-list--item--body--column_item--title">
                                ...
                                <div class="services--blocks-list--item--body--column_item--description">
                                    <p>Наиболее широко данная технология применяется для создания рекламной и сувенирной продукции на текстильных носителях: флаги, баннеры, растяжки, футболки, бейсболки, а также для фотопечати на керамической и стеклянной посуде, кружках, термосах и т.п.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="services--blocks-list--item" data-color="8">
                <div class="services--blocks-list--item--header">
                    <div class="container">
                        <div class="services--blocks-list--item--header--elements">
                            <div class="services--blocks-list--item--header--elements--counter">
                    ...
                    <div class="container">
                        <div class="services--blocks-list--item--body--columns">
                            ...
                            <div class="services--blocks-list--item--body--column">
                                ...
                                <div class="services--blocks-list--item--body--column_item--description">
                                    <p>Любые ежедневники из нашего <a href="/catalog/" style="color: #EF4A85;">Каталога</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="services--blocks-list--item" data-color="9">
                <div class="services--blocks-list--item--header">
                    <div class="container">
                        <div class="services--blocks-list--item--header--elements">
                            <div class="services--blocks-list--item--header--elements--counter">
                    ...
                    <div class="container">
                        <div class="services--blocks-list--item--body--columns">
                            ...
                            <div class="services--blocks-list--item--body--column">
                                ...
                                <div class="services--blocks-list--item--body--column_item--description">
                                    <p>Любой текстиль из нашего <a href="/catalog/" style="color: #EF4A85;">Каталога</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="alert-section">
            <div class="alert-card">
                <div class="alert-card--description">
                    ...
                    <a href="#" class="action--btn">Получить консультацию</a>
                </div>
            </div>
        </div>
    </div>
