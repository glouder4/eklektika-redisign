        ...
        <div style="display: none;" id="dostavka-modal-1">
            <div class="dostavka-modal-body">
                ...
                <div class="dostavka-modal-description">
                    <p class="description">
                        При доставке заказов на условиях самовывоза – доставка осуществляется силами и за счет средств клиента. Услуги по сборке и погрузке товара при таком способе доставки осуществляет Компания "ЙОкаталог" бесплатно.
                    </p>
                </div>
            </div>
        </div>
