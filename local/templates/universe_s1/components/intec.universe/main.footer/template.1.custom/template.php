...
?>
        ...
        <div style="display: none;" id="dostavka-modal-2">
            <div class="dostavka-modal-body">
                ...
                <div class="dostavka-modal-description">
                    <p class="description">
                        При подтверждении заказа до 14:00 - доставка возможна на следующий день .
                    </p>
                    <p class="description">
                        Бесплатная доставка по Москве (в пределах МКАД) при сумме заказа — от 25 000 рублей.
                    </p>
                    <p class="description">
                        Платная доставка по Москве (в пределах МКАД) — от 700 рублей (по согласованию с менеджером).
                    </p>
                </div>
            </div>
        </div>
        <div style="display: none;" id="dostavka-modal-3">
            <div class="dostavka-modal-body">
                ...
                <div class="dostavka-modal-description">
                    <p class="description">
                        При подтверждении заказа до 14:00 - доставка в транспортную компанию возможна на следующий день.
                        <br><br>
                        Минимальная сумма заказа для доставки в транпортную компанию до терминала в г.Москве – от 25 000 рублей.
                        <br><br>
                        Минимальная сумма заказа для доставки в транспортную компанию до терминала в городе клиента – от 35 000 рублей (по согласованию с менеджером)
                        <br><br>
                        Мы осуществляем доставки до следующих транспортных компаний
                        <br><br>
                        Деловые Линии <a href="http://www.dellin.ru/" target="_blank" rel="nofollow">http://www.dellin.ru/</a>
                        Байкал- Сервис <a href="http://www.baikalsr.ru/" target="_blank" rel="nofollow">http://www.baikalsr.ru/</a>
                        УТС - Удобная Транспортная Служба <a href="http://www.utsr.ru/" target="_blank" rel="nofollow">http://www.utsr.ru/</a>
                        <br><br>
                        Доставка в другие транспортные компании по согласованию с менеджером.
                    </p>
                </div>
            </div>
        </div>
