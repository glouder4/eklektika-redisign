...
$arParams = ArrayHelper::merge([
	...
	'FORMS_CALCULATE_SHOW' => 'N',
    'FORMS_CALCULATE_ID' => null,
    'FORMS_CALCULATE_TEMPLATE' => null,
    'FORMS_CALCULATE_TITLE' => null,
...
$arResult['FORMS']['CALCULATE'] = [
    'SHOW' => $arParams['FORMS_CALCULATE_SHOW'] === 'Y',
    'ID' => $arParams['FORMS_CALCULATE_ID'],
    'TEMPLATE' => $arParams['FORMS_CALCULATE_TEMPLATE'],
    'TITLE' => $arParams['FORMS_CALCULATE_TITLE']
];

if ($arResult['FORMS']['CALL']['SHOW'] && empty($arResult['FORMS']['CALL']['ID']))
    $arResult['FORMS']['CALL']['SHOW'] = false;

if ($arResult['FORMS']['CALCULATE']['SHOW'] && empty($arResult['FORMS']['CALCULATE']['ID']))
    $arResult['FORMS']['CALCULATE']['SHOW'] = false;
