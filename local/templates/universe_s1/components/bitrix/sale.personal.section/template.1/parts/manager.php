    ...
    <div class="manager-card-fields">
        <div class="manager-personal-info">
            <div class="manager--avatar_field">
                <?php
                    if( isset($arManager['PICTURE']) && !empty($arManager['PICTURE']) ){?>
            ...
            <div class="manager--info">
                <?php if (!empty($arManager['MANAGER_PROPERTY']['POSITION'])) { ?>
                    <div class="field post">
                        <span><?= $arManager['MANAGER_PROPERTY']['POSITION'] ?></span>
                    </div>
                <?php } ?>
                <div class="field name">
                    <span><?= $arManager['NAME'] ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="manager-action-links--wrapper">
            <?php if (!empty($arManager['MANAGER_PROPERTY']['PHONE'])) { ?>
                <div class="phone-link link">
                    <a href="tel:<?= $arManager['MANAGER_PROPERTY']['PHONE'] ?>">
                        <div class="icon"><?= $arSvg['PHONE'] ?></div>
                        <div class="data"><?= $arManager['MANAGER_PROPERTY']['PHONE'] ?></div>
                    </a>
                </div>
            <?php } ?>
            <?php if (!empty($arManager['MANAGER_PROPERTY']['EMAIL'])) { ?>
                <div class="email-link link">
                    <a href="mailto:<?= $arManager['MANAGER_PROPERTY']['EMAIL'] ?>">
                        <div class="icon"><?= $arSvg['EMAIL'] ?></div>
                        <div class="data"><?= $arManager['MANAGER_PROPERTY']['EMAIL'] ?></div>
                    </a>
                </div>
            <?php } ?>
        </div>
