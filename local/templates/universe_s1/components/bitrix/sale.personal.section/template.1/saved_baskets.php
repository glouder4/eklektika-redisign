...
?>
    ...
    $GLOBALS["filterBasket"] = [];

    if( !empty(intec\eklectika\SavedBasket::get()) ){
        $GLOBALS["filterBasket"] = ["ID" => intec\eklectika\SavedBasket::get()];
    }
    else{
        $GLOBALS["filterBasket"] = ["ID" => 0];
    }
