...
$arTemplateParameters['SEF_MODE']['kp'] = [
	'NAME' => "Страница для кп",
	'DEFAULT' => 'kp/',
	'VARIABLES' => ['ID']
];
$arTemplateParameters['SEF_MODE']['saved_baskets'] = [
	'NAME' => "Страница для сохраненных корзин",
	'DEFAULT' => 'saved_baskets/',
	'VARIABLES' => ['ID']
];
