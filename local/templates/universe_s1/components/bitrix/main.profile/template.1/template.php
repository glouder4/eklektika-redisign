                ...
                <?= Html::beginTag('div', [
                    ...
                    <?php } ?>
                            <?php foreach ($arResult['MAIN_FIELDS'] as $keyField => $valueField) { ?>
                                ...
                                <?= Html::endTag('div') ?>
                            <?php } ?>
							<?php foreach ($arResult['USER_PROPERTIES']["DATA"] as $keyField => $valueField) { 
                                ...
                                <?= Html::beginTag('div', [
                                    ...
                                    <?= Html::tag('label', $valueField["EDIT_FORM_LABEL"], [
                                        'class' => Html::cssClassFromArray([
                                            'main-profile-form-field-title' => $arVisual['READ_ONLY'],
                                            'intec-ui-form-field-title' => !$arVisual['READ_ONLY']
                                        ], true),
