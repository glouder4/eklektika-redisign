...
foreach ($arResult['ITEMS'] as &$arItem) {
    ...
    if ($arData['MARKS']['VALUES']['RECOMMEND'] || $arData['MARKS']['VALUES']['NEW'] || $arData['MARKS']['VALUES']['NEW'])
...
if ($arResult['BASE'] && class_exists(\OnlineService\Site\CatalogPriceFloor::class)
