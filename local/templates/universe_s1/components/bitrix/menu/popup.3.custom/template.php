...
<?= Html::beginTag('div', [
    ...
    <div class="menu-button" data-action="menu.open">
		<div class="intec-grid intec-grid-wrap intec-grid-a-v-center intec-grid-a-h-center intec-grid-i-h-5 button-icon-wrap">
			<div class="intec-grid-item-auto" style="font-size: 0; line-height: 0">
				<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path d="M3.33333 9.33268C2.59667 9.33268 2 8.73602 2 7.99935C2 7.26268 2.59667 6.66602 3.33333 6.66602C4.07 6.66602 4.66667 7.26268 4.66667 7.99935C4.66667 8.73602 4.07 9.33268 3.33333 9.33268Z" stroke="white" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
					<path d="M7.99935 9.33268C7.26268 9.33268 6.66602 8.73602 6.66602 7.99935C6.66602 7.26268 7.26268 6.66602 7.99935 6.66602C8.73602 6.66602 9.33268 7.26268 9.33268 7.99935C9.33268 8.73602 8.73602 9.33268 7.99935 9.33268Z" stroke="white" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
					<path d="M12.6673 9.33268C11.9307 9.33268 11.334 8.73602 11.334 7.99935C11.334 7.26268 11.9307 6.66602 12.6673 6.66602C13.404 6.66602 14.0007 7.26268 14.0007 7.99935C14.0007 8.73602 13.404 9.33268 12.6673 9.33268Z" stroke="white" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
					<path d="M3.33333 14.0007C2.59667 14.0007 2 13.404 2 12.6673C2 11.9307 2.59667 11.334 3.33333 11.334C4.07 11.334 4.66667 11.9307 4.66667 12.6673C4.66667 13.404 4.07 14.0007 3.33333 14.0007Z" stroke="white" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
					<path d="M7.99935 14.0007C7.26268 14.0007 6.66602 13.404 6.66602 12.6673C6.66602 11.9307 7.26268 11.334 7.99935 11.334C8.73602 11.334 9.33268 11.9307 9.33268 12.6673C9.33268 13.404 8.73602 14.0007 7.99935 14.0007Z" stroke="white" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
					<path d="M12.6673 14.0007C11.9307 14.0007 11.334 13.404 11.334 12.6673C11.334 11.9307 11.9307 11.334 12.6673 11.334C13.404 11.334 14.0007 11.9307 14.0007 12.6673C14.0007 13.404 13.404 14.0007 12.6673 14.0007Z" stroke="white" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
					<path d="M3.33333 4.66667C2.59667 4.66667 2 4.07 2 3.33333C2 2.59667 2.59667 2 3.33333 2C4.07 2 4.66667 2.59667 4.66667 3.33333C4.66667 4.07 4.07 4.66667 3.33333 4.66667Z" stroke="white" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
					<path d="M7.99935 4.66667C7.26268 4.66667 6.66602 4.07 6.66602 3.33333C6.66602 2.59667 7.26268 2 7.99935 2C8.73602 2 9.33268 2.59667 9.33268 3.33333C9.33268 4.07 8.73602 4.66667 7.99935 4.66667Z" stroke="white" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
					<path d="M12.6673 4.66667C11.9307 4.66667 11.334 4.07 11.334 3.33333C11.334 2.59667 11.9307 2 12.6673 2C13.404 2 14.0007 2.59667 14.0007 3.33333C14.0007 4.07 13.404 4.66667 12.6673 4.66667Z" stroke="white" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
				</svg>
			</div>
			<div class="intec-grid-item-auto">
				<?= Loc::getMessage('C_MENU_POPUP_3_BUTTON_TITLE') ?>
			</div>
		</div>
    </div>
    <?= Html::beginTag('div', [
