...
<?php if (!empty($arResult)) { ?>
    <div id="<?= $sTemplateId ?>" class="ns-bitrix c-menu c-menu-mobile-1">
        <div class="menu-button intec-cl-background" data-action="menu.open">
<svg width="23" height="18" viewBox="0 0 23 18" fill="none" xmlns="http://www.w3.org/2000/svg">
	<path d="M2.30188 16.2034H21.2108M2.30188 9.00002H21.2108M2.30188 1.79663H21.2108" stroke="white" stroke-width="2.70127" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
        </div>
