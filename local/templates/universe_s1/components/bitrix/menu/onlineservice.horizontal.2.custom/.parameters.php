...
$arTemplateParameters['IBLOCK_TYPE'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_MENU_HORIZONTAL_2_IBLOCK_TYPE'),
    'TYPE' => 'LIST',
...
$arTemplateParameters['IBLOCK_ID'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_MENU_HORIZONTAL_2_IBLOCK_ID'),
    'TYPE' => 'LIST',
    'VALUES' => $arIBlocks,
    'REFRESH' => 'Y',
    'ADDITIONAL_VALUES' => 'Y'
...
$arTemplateParameters['LAZYLOAD_USE'] = [
    'PARENT' => 'BASE',
    'NAME' => Loc::getMessage('C_MENU_HORIZONTAL_2_LAZYLOAD_USE'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N'
];
...
$arTemplateParameters['UPPERCASE'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_MENU_HORIZONTAL_2_UPPERCASE'),
    'TYPE' => 'CHECKBOX',
    'REFRESH' => 'Y'
];
...
$arTemplateParameters['TRANSPARENT'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_MENU_HORIZONTAL_2_TRANSPARENT'),
    'TYPE' => 'CHECKBOX',
    'REFRESH' => 'Y'
];
...
if ($arCurrentValues['TRANSPARENT'] != 'Y') {
    $arTemplateParameters['DELIMITERS'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MENU_HORIZONTAL_2_DELIMITERS'),
        'TYPE' => 'CHECKBOX'
    ];
}
...
if (!empty($iIBlockId)) {
    ...
    $arTemplateParameters['PROPERTY_IMAGE'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_MENU_HORIZONTAL_2_PROPERTY_IMAGE'),
        'TYPE' => 'LIST',
        'VALUES' => $arFields,
        'REFRESH' => 'Y',
        'ADDITIONAL_VALUES' => 'Y'
    ...
    $arTemplateParameters['PROPERTY_IMAGE_ELEMENTS'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_MENU_HORIZONTAL_2_PROPERTY_IMAGE_ELEMENTS'),
        'TYPE' => 'LIST',
...
$arTemplateParameters['SECTION_VIEW'] = [
    ...
    'VALUES' => [
        ...
        'information' => Loc::getMessage('C_MENU_HORIZONTAL_2_SECTION_VIEW_INFORMATION'),
        'banner' => Loc::getMessage('C_MENU_HORIZONTAL_2_SECTION_VIEW_BANNER')
    ],
    'REFRESH' => 'Y'
];
...
$arTemplateParameters['SUBMENU_VIEW'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_MENU_HORIZONTAL_2_SUBMENU_VIEW'),
    'TYPE' => 'LIST',
    'VALUES' => [
        'simple.1' => Loc::getMessage('C_MENU_HORIZONTAL_2_SUBMENU_VIEW_SIMPLE_1'),
        'simple.2' => Loc::getMessage('C_MENU_HORIZONTAL_2_SUBMENU_VIEW_SIMPLE_2')
    ],
    'REFRESH' => 'Y'
];
...
$arTemplateParameters['OVERLAY_USE'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_MENU_HORIZONTAL_2_OVERLAY_USE'),
    'TYPE' => 'CHECKBOX',
    'REFRESH' => 'Y'
];
...
if ($arCurrentValues['SECTION_VIEW'] == 'banner') {
    ...
    $arTemplateParameters['SECTION_BANNER_SHOW_ICONS_ROOT_ITEMS'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MENU_HORIZONTAL_2_SECTION_BANNER_SHOW_ICONS_ROOT_ITEMS'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N'
    ];
    ...
    $arTemplateParameters['SECTION_BANNER_SHOW'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MENU_HORIZONTAL_2_SECTION_BANNER_SHOW'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'Y',
        'REFRESH' => 'Y'
    ];
    ...
    $arTemplateParameters['SECTION_BANNER_MENU_SYNCHRONIZE'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_MENU_HORIZONTAL_2_SECTION_BANNER_MENU_SYNCHRONIZE'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'Y'
    ];
    ...
    if ( $arCurrentValues['SECTION_BANNER_SHOW'] === 'Y') {
        $arTemplateParameters['SECTION_BANNER_IBLOCK_TYPE'] = [
            'PARENT' => 'VISUAL',
            'NAME' => Loc::getMessage('C_MENU_HORIZONTAL_2_SECTION_BANNER_IBLOCK_TYPE'),
            'TYPE' => 'LIST',
            'VALUES' => $arIBlocksTypes,
            'REFRESH' => 'Y',
            'ADDITIONAL_VALUES' => 'Y'
        ...
        $arTemplateParameters['SECTION_BANNER_IBLOCK_ID'] = [
            'PARENT' => 'VISUAL',
            'NAME' => Loc::getMessage('C_MENU_HORIZONTAL_2_SECTION_BANNER_IBLOCK_ID'),
            'TYPE' => 'LIST',
        ...
        if (!empty($arCurrentValues['SECTION_BANNER_IBLOCK_ID'])) {
            ...
            $arTemplateParameters['SECTION_BANNER_PROPERTY_SECTION'] = [
                'PARENT' => 'VISUAL',
                'NAME' => Loc::getMessage('C_MENU_HORIZONTAL_2_SECTION_BANNER_PROPERTY_SECTION'),
                'TYPE' => 'LIST',
            ...
            $arTemplateParameters['SECTION_BANNER_PROPERTY_LINK'] = [
                'PARENT' => 'VISUAL',
                'NAME' => Loc::getMessage('C_MENU_HORIZONTAL_2_SECTION_BANNER_PROPERTY_LINK'),
                'TYPE' => 'LIST',
            ...
            $arTemplateParameters['SECTION_BANNER_HEADER_SHOW'] = [
                'PARENT' => 'VISUAL',
                'NAME' => Loc::getMessage('C_MENU_HORIZONTAL_2_SECTION_BANNER_HEADER_SHOW'),
                'TYPE' => 'CHECKBOX',
                'DEFAULT' => 'N'
            ];
            ...
            $arTemplateParameters['SECTION_BANNER_DESCRIPTION_SHOW'] = [
                'PARENT' => 'VISUAL',
                'NAME' => Loc::getMessage('C_MENU_HORIZONTAL_2_SECTION_BANNER_DESCRIPTION_SHOW'),
                'TYPE' => 'CHECKBOX',
                'DEFAULT' => 'N',
                'REFRESH' => 'Y'
            ];
            ...
            if ($arCurrentValues['SECTION_BANNER_DESCRIPTION_SHOW'] === 'Y') {
                $arTemplateParameters['SECTION_BANNER_DESCRIPTION_LIMIT'] = [
                    'PARENT' => 'VISUAL',
                    'NAME' => Loc::getMessage('C_MENU_HORIZONTAL_2_SECTION_BANNER_DESCRIPTION_LIMIT'),
                    'TYPE' => 'CHECKBOX',
                    'DEFAULT' => 'Y'
                ];
            }
            ...
            $arTemplateParameters['SECTION_BANNER_DOTS_SHOW'] = [
                'PARENT' => 'VISUAL',
                'NAME' => Loc::getMessage('C_MENU_HORIZONTAL_2_SECTION_BANNER_DOTS_SHOW'),
                'TYPE' => 'CHECKBOX',
                'DEFAULT' => 'Y'
            ];
            ...
            $arTemplateParameters['SECTION_BANNER_LOOP_USE'] = [
                'PARENT' => 'VISUAL',
                'NAME' => Loc::getMessage('C_MENU_HORIZONTAL_2_SECTION_BANNER_LOOP_USE'),
                'TYPE' => 'CHECKBOX',
                'DEFAULT' => 'N'
            ];
