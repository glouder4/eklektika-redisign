...
function showReservedInfo($offer) {
    ...
    $tooltip_1 = 'Свободный остаток с учетом резервов';
    $tooltip_2 = 'Свободный остаток с учетом резервов';
?>
    <div class="catalog-element-purchase-container-ostatok offer-stock-info" data-article="<?=$article?>" style="display: none;">
        ...
        <div class="catalog-element-ostatok">
            <div class="catalog-element-ostatok-name">Всего:</div>
            <div class="catalog-element-ostatok-number"><?=$OSTATOK_VMESTE_S_REZERVOM?> шт.</div>
        </div>
        <? if($OSTATOK_V_PUTI) {?>
        <div class="catalog-element-ostatok">
