...
?>
<div class="container">
    <div class="intec-grid intec-grid-wrap intec-grid-i-h-16 intec-grid-i-v-12 gap-flex-custom">
        <?php if (
            ...
            <?/*= Html::beginTag('div', [
                ...
                <div class="catalog-element-main-block-container">
                    <div class="intec-grid intec-grid-a-v-center intec-grid-i-8">
                        ...
                        <?php 
                        */
                        /* ПЕРЕНЕСЕНО В include(__DIR__ . '/main.container.view.1/purchase.php')
        ...
        <?= Html::beginTag('div', [
            'class' => Html::cssClassFromArray([
                'catalog-element-main-block-left' => true,
                'catalog-element-main-flex-left-custom' => true,
                'intec-grid-item' => [
        ...
        <?= Html::beginTag('div', [
            'class' => Html::cssClassFromArray([
                'catalog-element-main-block-right' => true,
                'catalog-element-main-flex-right-custom' => true,
                'intec-grid-item' => [
                    '3' => $bSkuDynamic || $arVisual['PROPERTIES']['PREVIEW']['SHOW'] || $arResult['SIZES']['SHOW'],
                    '2' => (!$bOffers || $bSkuList) && !$arVisual['PROPERTIES']['PREVIEW']['SHOW'] && !$arResult['SIZES']['SHOW'],
