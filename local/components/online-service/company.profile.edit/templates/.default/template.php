...
<div class="company-edit">
    <div class="company-edit__header">
        ...
        <a href="/company/profile/<?=$companyCode?>/" class="company-edit__back-btn">
            ...
            <div class="form-grid">
                <div class="form-group form-group--required">
                    ...
                    <input 
                        type="text" 
                        id="company_name" 
                        name="OS_COMPANY_NAME" 
                        class="form-input"
                        value="<?=htmlspecialchars($company['OS_COMPANY_NAME'] ?? '')?>"
                        required
                    >
                ...
                <div class="form-group form-group--required">
                    ...
                    <input 
                        ...
                        name="OS_COMPANY_INN" 
                        class="form-input"
                        value="<?=htmlspecialchars($company['OS_COMPANY_INN'] ?? '')?>"
                        required
                    >
                    <div class="form-error" style="display: none;">Поле обязательно для заполнения</div>
                </div>
                ...
                <div class="form-group form-group--required">
                    ...
                    <input 
                        type="text" 
                        id="company_city" 
                        name="OS_COMPANY_CITY" 
                        class="form-input"
                        value="<?=htmlspecialchars($company['OS_COMPANY_CITY'] ?? '')?>"
                        required
                    >
                    <div class="form-error" style="display: none;">Поле обязательно для заполнения</div>
                </div>
                ...
                <div class="form-group form-group--required">
                    ...
                    <input 
                        type="text" 
                        id="company_website"  
                        name="OS_COMPANY_WEB_SITE" 
                        class="form-input"
                        value="<?=htmlspecialchars($company['OS_COMPANY_WEB_SITE'] ?? '')?>"
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input 
                        type="tel" 
                        id="company_phone" 
                        name="OS_COMPANY_PHONE" 
                        class="form-input"
                        value="<?=htmlspecialchars($company['OS_COMPANY_PHONE'] ?? '')?>"
                ...
                <div class="form-group">
                    ...
                    <input 
                        type="email" 
                        id="company_email" 
                        name="OS_COMPANY_EMAIL" 
                        class="form-input"
                        value="<?=htmlspecialchars($company['OS_COMPANY_EMAIL'] ?? '')?>"
                    >
            ...
            <div class="form-grid form-grid--single">
                <div class="form-group">
                    ...
                    if (!empty($company['OS_REQUSITES_FILE'])) {
                        $currentFile = CFile::GetFileArray($company['OS_REQUSITES_FILE']);
                    }
                    ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        .then(data => {
            if (data.success) {
                const redirectUrl = '/company/profile/' + (data.company_code || '<?=$companyCode?>') + '/';
