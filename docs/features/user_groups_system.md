...
**Файл**: `local/modules/eklektika.b24.usersync/lib/User.php`, метод `update()`, строки 492-498
...
**Файл**: `local/modules/eklektika.b24.usersync/lib/User.php`, метод `update()`, строки 499-507
...
**Файл**: `local/modules/eklektika.b24.usersync/lib/User.php`, метод `updateMarketingAgentPriceType()`, строки 313-345
