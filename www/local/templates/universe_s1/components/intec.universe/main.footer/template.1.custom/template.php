        ...
        <div class="oplata-modal-body">
            ...
            <div class="oplata-modal-description">
                <p class="description">
                    ...
                    <b>При&nbsp;выборе формы оплаты с&nbsp;помощью банковской карты проведение платежа по&nbsp;заказу производится непосредственно после&nbsp;подтверждения его&nbsp;менеджером.<br/><br/>
                    </b>
