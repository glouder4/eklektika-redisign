...
$arTemplateParameters['FORMS_CALCULATE_SHOW'] = [
    'PARENT' => 'VISUAL',
    'NAME' => Loc::getMessage('C_HEADER_TEMP1_FORMS_CALCULATE_SHOW'),
    'TYPE' => 'CHECKBOX',
    'DEFAULT' => 'N',
    'REFRESH' => 'Y'
];
...
if ($arCurrentValues['FORMS_CALCULATE_SHOW'] == 'Y') {
    $arTemplateParameters['FORMS_CALCULATE_ID'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_HEADER_TEMP1_FORMS_CALCULATE_ID'),
        'TYPE' => 'LIST',
        'VALUES' => $arForms,
        'ADDITIONAL_VALUES' => 'Y'
    ];
    $arTemplateParameters['FORMS_CALCULATE_TEMPLATE'] = [
        'PARENT' => 'DATA_SOURCE',
        'NAME' => Loc::getMessage('C_HEADER_TEMP1_FORMS_CALCULATE_TEMPLATE'),
        'TYPE' => 'LIST',
        'VALUES' => $arTemplates,
        'DEFAULT' => '.default',
        'ADDITIONAL_VALUES' => 'Y'
    ];
    $arTemplateParameters['FORMS_CALCULATE_TITLE'] = [
        'PARENT' => 'VISUAL',
        'NAME' => Loc::getMessage('C_HEADER_TEMP1_FORMS_CALCULATE_TITLE'),
        'TYPE' => 'STRING',
        'DEFAULT' => Loc::getMessage('C_HEADER_TEMP1_FORMS_CALCULATE_TITLE_DEFAULT')
    ];
}
