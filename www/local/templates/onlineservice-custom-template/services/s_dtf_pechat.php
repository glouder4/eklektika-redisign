<?php
$APPLICATION->SetTitle("DTF печать");
    ...
    <section class="products-card-section">
        ...
        <div class="container">
            <div class="products-card-section--title_wrapper">
                <h3 class="title">Примеры нанесения методом DTF печати на разных видах сувенирной продукции </h3>
            </div>
        ...
        <div class="container">
            ...
            <div class="service-description-list_items">
                ...
                <div class="service-description-list--item">
                    ...
                    <div class="service-description-list--item--data">
                        <div class="service-description-list--item_title">
                            <span>Стойкость печатного рисунка</span>
                        </div>
                        <div class="service-description-list--item_description">
                            <p>Изображения, полученные с помощью DTF-печати, устойчивы к стирке, трению и другим воздействиям, что гарантирует долговечность изделий.</p>
                        </div>
                    </div>
                </div>
                <div class="service-description-list--item">
                    ...
                    <div class="service-description-list--item--data">
                        <div class="service-description-list--item_title">
                            <span>Возможность печати на различных товарах и материалах</span>
                        </div>
                        <div class="service-description-list--item_description">
                ...
                <div class="service-description-list--item">
                    ...
                    <div class="service-description-list--item--data">
                        <div class="service-description-list--item_title">
                            <span>Быстрота и эффективность</span>
                        </div>
                        <div class="service-description-list--item_description">
                            <p>DTF-печать выполняется быстро и эффективно, что сокращает время производства и повышает общую производительность предприятия.</p>
                        </div>
                    </div>
                </div>
                <div class="service-description-list--item">
                    ...
                    <div class="service-description-list--item--data">
                        <div class="service-description-list--item_title">
                            <span>Мягкость и эластичность наклеек, которые можно использовать впрок</span>
                        </div>
                        <div class="service-description-list--item_description">
                            <p>Полученное изображение приятно на ощупь и не трескается, что обеспечивает комфорт при использовании изделий. Наклейки можно изготавливать заранее и использовать их по мере необходимости.</p>
                        </div>
                    </div>
                </div>
                <div class="service-description-list--item">
                    ...
                    <div class="service-description-list--item--data">
                        <div class="service-description-list--item_title">
                            <span>Экологичность и экономичность</span>
                        </div>
                        <div class="service-description-list--item_description">
                            <p>Технология использует меньше чернил и воды по сравнению с традиционными методами печати, что снижает негативное воздействие на окружающую среду. Кроме того, DTF-печать позволяет сократить время производства, так как процесс термопереноса происходит быстрее, чем, например, сублимационная печать.</p>
                        </div>
                    </div>
                </div>
                <div class="service-description-list--item">
                    ...
                    <div class="service-description-list--item--data">
                        <div class="service-description-list--item_title">
                            <span>Гибкость настройки</span>
                        </div>
                        <div class="service-description-list--item_description">
                            <p>DTF-технология позволяет легко настраивать параметры печати, такие как размер, цвет и количество изделий, что обеспечивает максимальную адаптацию к потребностям заказчика.</p>
                        </div>
                    </div>
                </div>
            </div>
