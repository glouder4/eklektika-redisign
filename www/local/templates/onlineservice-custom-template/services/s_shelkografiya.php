...
$GLOBALS["OS_BREADCRUMBS"] = [
    [
        'ITEM' => "Шелкография на ткани",
        "LINK" => "/services/s_shelkografiya/",
    ]
];
?>
<div class="container">
            ...
            <div class="alert-card">
                <div class="alert-card--description">
                    <?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
                            "AREA_FILE_SHOW" => "file",
                            "PATH" => "/local/templates/onlineservice-custom-template/services/include/index_s_shelkografiya.php",
                            "AREA_FILE_SUFFIX" => "",
                            "EDIT_TEMPLATE" => ""
                        )
                    );?>
