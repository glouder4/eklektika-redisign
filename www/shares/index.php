...
<?php $APPLICATION->IncludeComponent(
	...
	array(
		...
		"DETAIL_PRODUCTS_IBLOCK_TYPE" => "1c_catalog",
		"DETAIL_PRODUCTS_IBLOCK_ID" => "43",
		...
		"DETAIL_PRODUCTS_QUICK_VIEW_PROPERTY_CODE" => array(
			...
			12 => "PROPERTY_SEASON",
			13 => "PROPERTY_PATTERN",
			14 => "PROPERTY_YSENSITIVITY",
			15 => "PROPERTY_FREQUENCY_RANGE",
			16 => "PROPERTY_TYPE_SIZE",
			17 => "PROPERTY_FREEZER",
			18 => "PROPERTY_CONTROL",
			19 => "PROPERTY_COMPRESSORS",
			20 => "PROPERTY_DIMENSIONS",
			21 => "PROPERTY_NOISE",
			22 => "PROPERTY_TIMER",
			23 => "PROPERTY_VERTEL",
			24 => "PROPERTY_FUNCTIONS",
			25 => "PROPERTY_CLEANING",
			26 => "PROPERTY_RECIPES",
			27 => "PROPERTY_DEFROSTING",
			28 => "PROPERTY_SPIN",
			29 => "PROPERTY_COFFEE",
			30 => "PROPERTY_COFFEE_MACHINE",
			31 => "PROPERTY_DIAGONAL",
			32 => "PROPERTY_RESOLUTION",
			33 => "PROPERTY_LED",
			34 => "PROPERTY_STEREO_SOUND",
			35 => "PROPERTY_ACOUSTICS",
			36 => "PROPERTY_SURROUND_SOUND",
			37 => "PROPERTY_FORMATS",
			38 => "PROPERTY_SLEEVE",
			39 => "PROPERTY_CLASP",
			40 => "PROPERTY_TOP_MATERIAL",
			41 => "PROPERTY_INNER_MATERIAL",
			42 => "PROPERTY_BASE_MATERIAL",
			43 => "PROPERTY_MATERIAL_ARTICLE",
			44 => "PROPERTY_HEEL",
			45 => "PROPERTY_ENGINE",
			46 => "PROPERTY_DRYING",
			47 => "PROPERTY_ingredient",
			48 => "PROPERTY_WIDTH",
			49 => "PROPERTY_HEIGHT",
			50 => "PROPERTY_BOTTOM_WIDTH",
			51 => "PROPERTY_HANDLE_LENGTH",
			52 => "PROPERTY_INTERNAL_POCKETS",
			53 => "PROPERTY_LEGS",
			54 => "PROPERTY_EQUIPMENT",
			55 => "PROPERTY_POCKETS",
			56 => "PROPERTY_HOOD",
			57 => "",
		),
		...
		"DETAIL_PRODUCTS_FORM_PROPERTY_PRODUCT" => "form_text_21",
